...
<head>
    ...
    <title>Receipt_<?php echo date('Ymd') . '_Order_' . $order_id; ?></title>
...
<body>
    <div class="receipt-container">
        ...
        <div class="total-section">
            ...
            <p>Cash Paid: ₱<?php echo number_format($cash, 2); ?></p>
        ...
        <p class="thank-you">Thank you for your order!<br>Come Again!!</p>
